  ...
  const features = [
    {
      ...
      description: "Find and explore destinations along your travel route.",
    },
    {
      icon: "fas fa-save",
      title: "Save Your Itinerary",
      description: "Save and reuse your travel plans for future trips.",
    },
    // { icon: 'fas fa-map-marked-alt', title: 'Personalized Trips', description: 'Get recommendations tailored to your preferences.' },
    {
      icon: "fas fa-calendar-alt",
      title: "Easy Planning",
      description: "Plan your trips effortlessly with our tools.",
    },
    {
      icon: "fas fa-star",
      title: "Top Destinations",
      description: "Explore the best destinations around the world.",
    },
    ...
    // { icon: 'fas fa-wallet', title: 'Travel Budget Planner', description: 'Estimate and manage your travel expenses with ease.' },
    {
      ...
      description: "Explore and select destinations using an interactive map.",
    },
    // { icon: 'fas fa-shield-alt', title: 'Travel Safety Tips', description: 'Stay informed with safety tips for your destinations.' },
    {
      icon: "fas fa-route",
      title: "Custom Itineraries",
      description: "Create and customize your own travel plans.",
    },
    ...
    // { icon: 'fas fa-book', title: 'Travel Diary', description: 'Document your travel experiences and memories digitally.' },
    {
      ...
      description:
        "Filter destinations by location, type, and activities within a given radius.",
    },
  ];
