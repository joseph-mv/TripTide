...
// console.log('travelDays',maxTravelDays,totalHours)
  useEffect(() => {
    if (totalHours/5 > maxTravelDays) {
      ...
      setMessage(`Your planned travel time of ${travelTime} exceeds our limit of ${maxTravelDays} days. We recommend traveling 4 to 8 hours per day for a comfortable trip,
    ...
    isVisible && (
      <div className="popup-overlay">
        <div className="popup-content">
          ...
          <button onClick={handleChangeDate} className="change-date-button">Change Date</button>
